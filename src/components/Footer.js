      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 items-center">
          ...
          <div className="lg:col-span-1">
            <h3 className="font-playfair text-2xl font-light mb-2">
              Prissy Salon
            </h3>
            <p className="font-poppins text-cream-200 text-sm font-light">
          ...
          <div className="space-y-2">
            <div className="flex items-center space-x-2">
              ...
              <p className="font-poppins text-cream-200 text-sm">
                123 Beauty Lane, Salon District
              </p>
            </div>
            <div className="flex items-center space-x-2">
              <span className="text-cream-300">📞</span>
          ...
          {/* Business Hours */}
          <div className="space-y-2">
            <h4 className="font-playfair text-sm font-light text-cream-100 mb-2">Hours</h4>
          ...
          <div className="space-y-4">
            <h4 className="font-playfair text-sm font-light text-cream-100 mb-2">Follow Us</h4>
            <div className="flex space-x-3">
              ...
              <a 
                href="#" 
                className="w-10 h-10 bg-yellow-500 hover:bg-yellow-600 rounded-full flex items-center justify-center transition-colors duration-300"
                aria-label="Snapchat"
              >
                <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
        ...
        {/* Bottom Bar */}
        <div className="border-t border-cream-700 mt-6 pt-4">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="font-poppins text-cream-300 text-xs">
